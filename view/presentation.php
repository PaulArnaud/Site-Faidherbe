<body>
	...
	<div class=" position-relative bg-info mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
		<div class="my-3 p-3">
			...
			<a class="btn btn-outline-light bg-danger" href ng-click="tab = 7">Chants</a>
		</div>
	</div>
	...
	<div class=" position-relative bg-info mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
		<div class="my-3 p-3">
			...
			<a class="btn btn-outline-light bg-danger" href ng-click="tab = 8">Khâlots</a>
		</div>
	</div>
	<div class="position-relative bg-info mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
		<div class="my-3 p-3">
			...
			<p class="lead">
				Retrouvez ici une carte pour localiser les anciens.
			</p>
			<a class="btn btn-outline-light bg-danger" href="https://drive.google.com/open?id=1ccwASpKw8JI7YLZ3VzykNfhJ9kawTSB-&usp=sharing">Carte</a>
		</div>
	</div>
</body>
