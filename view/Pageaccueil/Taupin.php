...
<html lang="en">
	<head>
		...
		<title> Page Chants Taupin </title>
	</head>
	<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm text-center">
						<h2><u> HYMNE TAUPIN : JEHOVAH </u></h2>
					...
					<div class="col-sm text-center">
						<h2><u>  CRI DE GUERRE TAUPIN </u></h2>
						C'est Taupin, Taupin, Taupin qui fait marcher les machines
						<br>
						C'est Taupin, Taupin, Taupin qui fait marcher les engins
						<br>
						Taupiiin, Taupiiin qui fait marcher les machines
						<br>
						Taupiiin, Taupiiin qui fait marcher les engins
						<br>
					</div>
				</main>
